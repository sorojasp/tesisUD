...
boolean connectToWifiNetwork(String wifiNetworkName, String password){
  ...
  boolean sendSensorData(String serverName, String endPoint, int port,  struct concentracionesSensores  cs, WiFiClient client, String text_probe){

     String queryString = "?Authorization="+String(cs.NH3)+"&co2="+String(cs.SO2)+"&so2="+String(cs.CO2)+"&text_probe="+text_probe;
